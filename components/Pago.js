...
export default function Pago({open, handleClick}) {
  return (
    <>
        ...
        <div className='flex items-center justify-center min-h-screen'>
            <div className="bg-white py-8 w-[430px] px-12 rounded-md">
                <form>
                    ...
                    <select className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline' name="select">
